...
通过引擎回放历史 tick 数据，精确验证竞价表现和快速涨停买点。

用法:
    cd /home/fy/myown/livetrade
    python backtest/backtest_strong_gets_stronger_tick.py --date 2026-04-02
"""
        ...
        "strategies": {
            "strong_gets_stronger": {
                ...
                "params": {
                    ...
                    "open_strength_min": 0.09,
                    "limit_approach_pct": 0.99,
                    "limit_approach_by_time": "09:40:00",
                },
            },
        },
    }
...
def main():
    parser = argparse.ArgumentParser(description="强更强策略 — Tick回测")
